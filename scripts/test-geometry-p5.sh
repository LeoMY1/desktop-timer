...
cd "$project_root"
test_root="$project_root/work/p5-build/geometry"
sdk_path="$(xcrun --show-sdk-path)"
mkdir -p "$test_root" "$project_root/work/p5-evidence"
...
"$test_root/GeometryChecks" "$project_root/work/p5-evidence/geometry-checks.json"
