...
cd "$project_root"
build_root="$project_root/work/p3-build/tests"
mkdir -p "$build_root"
...
xcrun swiftc "${args[@]}" -I "$build_root" Tests/StudyCoreChecks/main.swift "$build_root/StudyCore.o" -o "$build_root/CoreChecks"
"$build_root/CoreChecks" "$project_root/work/p3-evidence/core"
