...
cd "$project_root"
test_root="$project_root/work/build/geometry"
sdk_path="$(xcrun --show-sdk-path)"
mkdir -p "$test_root" "$project_root/work/evidence"
...
"$test_root/GeometryChecks" "$project_root/work/evidence/geometry-checks.json"
